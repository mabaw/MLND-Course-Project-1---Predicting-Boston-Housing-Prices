...
def explore_city_data(city_data):
    ...
    # Size of data?
    size = housing_prices.size
    print "Size of data = %d" % size

    # Number of features?
    n_feature = housing_features[0].size
    print "Number of features = %d" % n_feature

    # Minimum value?
    min_price = housing_prices.min()
    print "Minimum value = %.2f" % min_price

    # Maximum Value?
    max_price = housing_prices.max()
    print "Maximum value = %.2f" % max_price

    # Calculate mean?
    mean_price = housing_prices.mean()
    print "Mean = %f" % mean_price
